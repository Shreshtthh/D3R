...
contract FundPool is Ownable {
    ...
    function getFundDetails(uint256 _fundId) external view returns (
        address ngo,
        uint256 totalAmount,
        uint256 releasedAmount,
        bool completed,
        ...
        return (
            ...
            fund.releasedAmount,
            fund.completed,
            fund.milestones.length
        );
    }
    
    function getMilestone(uint256 _fundId, uint256 _milestoneIndex) external view returns (
